  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage: `url(${
            import.meta.env.VITE_PUBLIC_URL + "/assets/img/bg/bg-7.jpg"
          })`
        }}
      >
        <div className="video-popup-2__content">
          ...
          <div className="link">
            <Link to={import.meta.env.VITE_PUBLIC_URL + "/about"}>Shop Now</Link>
          </div>
        </div>
        <ModalVideo
          channel="youtube"
        ...
        <div className="video-popup-2__button">
          <button onClick={() => isOpen(true)}>
            <img
              src={import.meta.env.VITE_PUBLIC_URL + "/assets/img/icon-img/play.png"}
              alt=""
            />
          </button>
        </div>
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${
            import.meta.env.VITE_PUBLIC_URL + "/assets/img/bg/bg-8.jpg"
          })`
        }}
      ></div>
    </div>
